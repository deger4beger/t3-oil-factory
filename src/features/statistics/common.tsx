const Common = ({
	...
	return (
		<div className="m-4 font-semibold text-zinc-300 p-2">
			...
			<p
				className={
					"flex justify-between items-center border-b-[3px] p-2 mb-2" +
					(outcome ?? 0 > 0 ? " border-emerald-700" : " border-red-700")
				}
			>
				<span>Общий доход за указанный период</span>
				{outcome ?? 0 > 0 ? "+ " : "- "}
				{outcome}
			</p>
		</div>
